...
[Demo](https://taste-bot.herokuapp.com/) of the taste-bots web app.Data for all restaurants could not be gathered properly .  For Barbeque Nation data was taken and transformed, so detailed review analysis would be there for it. Other restaurants for which data could be gathered were Bologna, Chez Mariannick, Toscano, Mani's Dum Biryani
